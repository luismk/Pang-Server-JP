    ...
    public class Guild
    {
        ...
        public void addPlayer(Player _session)
        {
            ...
            if (findPlayerByUID(_session.m_pi.uid) != null)
            {
                ...
                // Log
                message_pool.push(new message("[Guild::addPlayer][WARNING] tentou adicionar o player[UID=" + Convert.ToString(_session.m_pi.uid) + "] na guild, mas ele ja existe na guild. Bug", type_msg.CL_FILE_LOG_AND_CONSOLE));
        ...
        public void deletePlayer(Player _session)
        {
            ...
            if (_session == null)
            {
                ...
                message_pool.push(new message("[Guild::deletePlayer][Error] _session is invalid(nullptr). Bug", type_msg.CL_FILE_LOG_AND_CONSOLE));
            ...
            {
                message_pool.push(new message("[Guild::deletePlayer][WARNING] Player[UID=" + Convert.ToString(_session.m_pi.uid) + "] ja foi deletado do vector. Bug", type_msg.CL_FILE_LOG_AND_CONSOLE));
            }
        ...
        public Player getPlayerByIndex(uint _index)
        {
            ...
            if (_index > v_players.Count())
            {
                ...
                message_pool.push(new message("[Guild::getPlayerByIndex][Error] index[VALUE=" + Convert.ToString(_index) + "] is invalid(out_of_bounds)", type_msg.CL_FILE_LOG_AND_CONSOLE));
