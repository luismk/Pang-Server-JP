...
//                packet_func.room_broadcast(this, packet_func.pacote048(_session, v_element, 0x100), 1);

//                // Option 1, passa só o Player que entrou na sala, nesse caso foi o Bot
//                packet_func.room_broadcast(this, packet_func.pacote048(_session, new List<PlayerRoomInfoEx> { pri }, 0x101), 1);
...
//                                        packet_func.session_send(packet_func.pacote04B(_session,
