    ...
    public class GuildRoomManager
    {
        ...
        public void deleteGuild(Guild _guild)
        {
            ...
            if (_guild == null)
            {
                ...
                message_pool.push(new message("[GuildRoomManager::deleteGuild][Error] _guild is invalid(nullptr). Bug.", type_msg.CL_FILE_LOG_AND_CONSOLE));
        ...
        public void init_duplas()
        {
            ...
            if (v_guilds.Count != 2)
            {
                ...
                message_pool.push(new message("[GuildRoomManager::init_duplas][Error] nao tem duas guilds[NUM=" + Convert.ToString(v_guilds.Count) + "] para inicializar as duplas. Bug.", type_msg.CL_FILE_LOG_AND_CONSOLE));
            ...
            object _arg)
        {
            ...
            if (_arg == null)
            {
                message_pool.push(new message("[GuildRoomManager::SQLDBResponse][WARNING] _arg is nullptr com msg_id = " + Convert.ToString(_msg_id), type_msg.CL_FILE_LOG_AND_CONSOLE));
                return;
            }
            ...
            {
                message_pool.push(new message("[GuildRoomManager::SQLDBResponse][Error] " + _pangya_db.getException().getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
                return;
            }
