    ...
    public class DuplaManager
    {
        ...
        public void addDupla(Player _p1, Player _p2)
        {
            ...
            if (_p1 == null || _p2 == null)
            {
                ...
                _smp.message_pool.push(new message("[DuplaManager::addDupla][Error] _p" + (_p1 == null && _p2 == null ? "1 and _p2" : (_p1 == null ? "1" : "2")) + " is invalid", type_msg.CL_FILE_LOG_AND_CONSOLE));
        ...
        public void deleteDupla(Dupla _dupla)
        {
            ...
            if (_dupla == null)
            {
                ...
                _smp.message_pool.push(new message("[DuplaManager::deleteDupla][Error] _dupla is invalid(nullptr). Bug", type_msg.CL_FILE_LOG_AND_CONSOLE));
        ...
        public uint getNumPlayersQuitGuild(Guild _g)
        {
            ...
            if (_g == null)
            {
                ...
                _smp.message_pool.push(new message("[DuplaManager::getNumPlayersQuitGuild][Error] _g is invalid(nullptr). Bug.", type_msg.CL_FILE_LOG_AND_CONSOLE));
        ...
        public void updatePangWinDuplas(Guild _g, uint _pang_win)
        {
            ...
            if (_g == null)
            {
                ...
                _smp.message_pool.push(new message("[DuplaManager::updatePangWinDuplas][Error] _g is invalid(nullptr). Bug.", type_msg.CL_FILE_LOG_AND_CONSOLE));
        ...
        public void saveGuildMembersData()
        {
            ...
            catch (exception e)
            {
                ...
                _smp.message_pool.push(new message("[DuplaManager::saveGuildMembersData][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }
        }
        ...
        public bool finishHoleDupla(PlayerGameInfo _pgi, ushort _seq_hole)
        {
                ...
                || _seq_hole == 0u)
            {
                ...
                _smp.message_pool.push(new message("[DuplaManager::finishHoleDupla][Error] _seq_hole is invalid[VALUE=" + Convert.ToString(_seq_hole) + "]. Bug.", type_msg.CL_FILE_LOG_AND_CONSOLE));
            ...
            if (dup != null)
            {
                ...
                var dup_p_index = (dup.p[0] != null && dup.p[0].m_pi.uid == _pgi.uid) ? 0u : 1u;
                var other_p_index = (dup_p_index == 0u) ? 1u : 0u;

                dup.dados[dup_p_index][_seq_hole - 1].tacada = _pgi.data.tacada_num;
                dup.pang[dup_p_index] = _pgi.data.pang;
                dup.dados[dup_p_index][_seq_hole - 1].finish = 1;
                ...
                else if (dup.dados[other_p_index][_seq_hole - 1].finish == 1)
                {
            ...
            object _arg)
        {
            ...
            if (_arg == null)
            {
                _smp.message_pool.push(new message("[DuplaManager::SQLDBResponse][WARNING] _arg is nullptr com msg_id = " + Convert.ToString(_msg_id), type_msg.CL_FILE_LOG_AND_CONSOLE));
                return;
            }
