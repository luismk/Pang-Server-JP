    ...
    public class PremiumSystem
    {
            ...
            try
            {
                    ...
                    && _session.m_pi.pt.unix_sec_date <= 0)
                {
                    ...
                    if (it == _session.m_pi.mp_wi.Last().Value)
                    {
                        ...
                        ////ticket = item_manager._ownerItem(_session.m_pi.m_uid, _session.m_pi.pt._typeid);

                        //if (ticket.id <= 0)
                        //{
                        //   // _smp.message_pool.getInstance().push(new message("[PremiumSystem::checkEndTimeTicket][Error] player[UID=" + Convert.ToString(_session.m_pi.m_uid) + "] nao tem o item Ticket Premium. Bug", CL_FILE_LOG_AND_CONSOLE));
                    ...
                    item.c[0] = Convert.ToUInt16(item.qntd * -1);

                    // UPDATE ON SERVER AND DB
                    //if (item_manager.removeItem(item, _session) <= 0)
                    //{
                    //    throw new exception("[PremiumSystem::checkEndTimeTicket][Error] player[UID=" + Convert.ToString(_session.m_pi.m_uid) + "] tentou excluir ticket premium user, mas nao conseguiu deletar ele. Bug", ExceptionError.STDA_MAKE_ERROR_TYPE(STDA_ERROR_TYPE.PREMIUM_SYSTEM,
                    //        10000, 0));
                    //}

                    // Log
                    //// _smp.message_pool.getInstance().push(new message("[PremiumSystem::checkEndTimeTicket][Log] Player[UID=" + Convert.ToString(_session.m_pi.m_uid) + "].\tExcluiu ticket premium do player.", CL_ONLY_FILE_LOG));
            ...
            uint _time)
        {
            ...
            try
            {
                ...
                //// _smp.message_pool.getInstance().push(new message("[PremiumSystem::addPremiumUser][Log] Add Comet Premium e set Capability do player[UID=" + Convert.ToString(_session.m_pi.m_uid) + "]", CL_FILE_LOG_AND_CONSOLE));
                //// _smp.message_pool.getInstance().push(new message("[PremiumSystem::addPremiumUser][Log] Agora o Player[UID=" + Convert.ToString(_session.m_pi.m_uid) + "] eh um Premium User por (" + Convert.ToString(_time) + ") Dias", CL_FILE_LOG_AND_CONSOLE));
                ...
                // {
                //     throw new exception("[PremiumSystem::addPremiumUser][Error] Player[UID=" + Convert.ToString(_session.m_pi.m_uid) + "] nao conseguiu adicionar a Premium Ball.", ExceptionError.STDA_MAKE_ERROR_TYPE(STDA_ERROR_TYPE.PREMIUM_SYSTEM,
                //         300, 0));
                // }
                ...
                //     {
                //         throw new exception("[PremiumSystem::addPremiumUser][Error] Player[UID=" + Convert.ToString(_session.m_pi.m_uid) + "] nao conseguiu adicionar o Premium ClubSet.", ExceptionError.STDA_MAKE_ERROR_TYPE(STDA_ERROR_TYPE.PREMIUM_SYSTEM,
                //             300, 0));
                //     }
                ...
                //     {
                //         throw new exception("[PremiumSystem::addPremiumUser][Error] Player[UID=" + Convert.ToString(_session.m_pi.m_uid) + "] nao conseguiu adicionar o Premium Mascot.", ExceptionError.STDA_MAKE_ERROR_TYPE(STDA_ERROR_TYPE.PREMIUM_SYSTEM,
                //             300, 0));
                //     }
        ...
        public void removePremiumUser(Player _session)
        {
            ...
            try
            {
                ...
                // Log
                // _smp.message_pool.getInstance().push(new message("[PremiumSystem::removePremiumUser][Log] player[UID=" + Convert.ToString(_session.m_pi.m_uid) + "] removeu o Premium User do Player, acabou o tempo do ticket, tirando a capacidade e a Comet(Ball)", CL_FILE_LOG_AND_CONSOLE));
        ...
        public stItem addPremiumClubSet(Player _session, uint _time)
        {
            ...
            //    if (item._typeid == 0u)
            //    {
            //        throw new exception("[PremiumSystem::addPremiumClubSet][Error] Player[UID=" + Convert.ToString(_session.m_pi.m_uid) + "] nao conseguiu inicializar o item[TYPEID=" + Convert.ToString(bi._typeid) + "]", ExceptionError.STDA_MAKE_ERROR_TYPE(STDA_ERROR_TYPE.PREMIUM_SYSTEM,
            //            400, 0));
            //    }
            ...
            //        _session, 0, 0) < 0)
            //    {
            //        throw new exception("[PremiumSystem::addPremiumClubSet][Error] Player[UID=" + Convert.ToString(_session.m_pi.m_uid) + "] nao conseguiu adicionar o item[TYPEID=" + Convert.ToString(item._typeid) + "]", ExceptionError.STDA_MAKE_ERROR_TYPE(STDA_ERROR_TYPE.PREMIUM_SYSTEM,
            //            401, 0));
            //    }
        ...
        public stItem addPremiumMascot(Player _session, uint _time)
        {
            ...
            //    if (item._typeid == 0u)
            //    {
            //        throw new exception("[PremiumSystem::addPremiumMascot][Error] Player[UID=" + Convert.ToString(_session.m_pi.m_uid) + "] nao conseguiu inicializar o item[TYPEID=" + Convert.ToString(bi._typeid) + "]", ExceptionError.STDA_MAKE_ERROR_TYPE(STDA_ERROR_TYPE.PREMIUM_SYSTEM,
            //            400, 0));
            //    }
            ...
            //        _session, 0, 0) < 0)
            //    {
            //        throw new exception("[PremiumSystem::addPremiumMascot][Error] Player[UID=" + Convert.ToString(_session.m_pi.m_uid) + "] nao conseguiu adicionar o item[TYPEID=" + Convert.ToString(item._typeid) + "]", ExceptionError.STDA_MAKE_ERROR_TYPE(STDA_ERROR_TYPE.PREMIUM_SYSTEM,
            //            401, 0));
            //    }
        ...
        public void updatePremiumUser(Player _session)
        {
            ...
            //    if (new_ball._typeid == 0u)
            //    {
            //        throw new exception("[PremiumSystem::updatePremiumUser][Error] Player[UID=" + Convert.ToString(_session.m_pi.m_uid) + "] nao conseguiu adicionar a Premium Ball.", ExceptionError.STDA_MAKE_ERROR_TYPE(STDA_ERROR_TYPE.PREMIUM_SYSTEM,
            //            300, 0));
            //    }
