namespace GameServer.PangyaEnums
{
    ...
    {
        PLAYER_REQUEST_LOGIN = 0x0002,
        PLAYER_REQUEST_CHAT = 0x0003,
        PLAYER_REQUEST_SELECT_LOBBY = 0x0004,

        PLAYER_REQUEST_CREATE_GAME = 0x0008,
        PLAYER_REQUEST_JOIN_GAME = 0x0009,

        PLAYER_CHANGE_NICKNAME = 0x0038,
        PLAYER_CLIENT_EXCEPTION = 0x33,
        ...
        PLAYER_REQUEST_CHANGE_LOBBY = 0x0083,
        ...
        // DIALY LOGIN
        PLAYER_REQUEST_ATTENDANCE_DAILY_ITEM = 0x016E,
        PLAYER_REQUEST_ATTENDANCE_NEXT_ITEM = 0x016F,
        ...
        // QUEST
        PLAYER_REQUEST_LOAD_QUEST = 0x0151,
        ...
        PLAYER_REQUEST_CADDIE_EXPIRATION = 0x006B,

        PLAYER_UPGRADE_STATUS = 0x0188,
        PLAYER_DOWNGRADE_STATUS = 0x0189,   
        PLAYER_SEND_KEY_ACESS_WEB = 0x00FB,
        PLAYER_WEB_LINK_STATE = 0x00A1,
        PLAYER_CLOSE_WEB_LINK = 0x003D,
        PLAYER_REQUEST_EVENT_WORKSHOP = 0x0172,
        PLAYER_REQUEST_RANK_SERVER = 0x0047
    }
}
