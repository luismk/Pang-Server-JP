    ...
    public class LoginManager
    {
        ...
        public void requestLogin(Player _session, Packet _Packet)
        {
            ...
            try
            {
                ...
                NormalManagerDB.add(5, new CmdRegisterLogon(pi.uid, 0/*Logou*/), Program.gs.SQLDBResponse, Program.gs);

                // Resgistra o Login do Player no gs
                NormalManagerDB.add(7, new CmdRegisterLogonServer(pi.uid, Program.gs.m_si.uid), Program.gs.SQLDBResponse, Program.gs);
