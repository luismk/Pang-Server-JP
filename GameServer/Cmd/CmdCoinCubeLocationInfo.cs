...
using MAP_HOLE_COIN_CUBE = System.Collections.Generic.Dictionary<byte, System.Collections.Generic.List<Pangya_GameServer.GameType.CubeEx>>;
namespace Pangya_GameServer.Cmd
{
    public class CmdCoinCubeLocationInfo : Pangya_DB
    {
        ...
        protected override void lineResult(ctx_res _result, uint _index)
        {
           ...
           IFNULL<float>(_result.data[6]),
            ...
            else
            {
                ...
                {
                    message_pool.push(new message("[CmdCoinCubeLocationInfo::lineResult][WARNING] nao conseguiu inserir hole[NUMBER=" + Convert.ToString((ushort)hole) + "] e cube no map<>", type_msg.CL_FILE_LOG_AND_CONSOLE));
                }
            }
        }
        ...
        protected override Response prepareConsulta()
        {
            ...
            var r = consulta(getConsultaWithLimit());
