...
namespace Pangya_GameServer.Cmd
{
    public class CmdDeleteCard : Pangya_DB
    {
        ...
        protected override Response prepareConsulta()
        {
            ...
            var r = _update(m_szConsulta[0] + _db.makeText("N") + m_szConsulta[1] + Convert.ToString(m_uid) + m_szConsulta[2] + Convert.ToString(m_id));
        ...
        private string[] m_szConsulta = { "UPDATE pangya.pangya_card SET QNTD = 0, USE_YN = ", " WHERE UID = ", " AND card_itemid = " };
    }
}