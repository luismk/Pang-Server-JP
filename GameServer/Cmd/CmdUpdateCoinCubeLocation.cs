...
//			{
//				this.m_ccu = new <type missing>();
//			}

//			public CmdUpdateCoinCubeLocation(CoinCubeUpdate _ccu, bool _waiter = false) : base(_waiter)
//			{
//				this.m_ccu = _ccu;
//			}
...
//				if(sIff.getInstance().findCourse(iff.COURSE << 0x1A | (m_ccu.course_id & 0x7Fu)) == null)
//				{
...
//			{
//				return "CmdUpdateCoinCubeLocation";
//			}
