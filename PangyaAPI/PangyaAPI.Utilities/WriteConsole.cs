...
namespace PangyaAPI.Utilities
{
    public static class WriteConsole
    {
        ...
        static bool _vShowMessage(Message_Type flag, string message = "", string title = "")
        {
            if (message == "")
            {
        ...
        public static void DebugPacketUnknown(byte type, string message, params object[] args)
        {
            _vShowMessage((Message_Type)type, string.Format(message, args));
        }

        public static void Information(string message, params object[] args)
        {
            _vShowMessage(Message_Type.MSG_INFORMATION, string.Format(message, args));
        }

        public static void Notice(string message, params object[] args)
        {
            _vShowMessage(Message_Type.MSG_NOTICE, string.Format(message, args));
        }

        public static void Warning(string message, params object[] args)
        {
            _vShowMessage(Message_Type.MSG_WARNING, string.Format(message, args));
        }

        public static void Debug(string message, params object[] args)
        {
            _vShowMessage(Message_Type.MSG_DEBUG, string.Format(message, args));
        }
        ...
        {
            _vShowMessage(Message_Type.MSG_FATALERROR, string.Format(DateTime.Now.ToString("[yyyy/MM/dd HH:mm:ss] ") + message, args));
        }
        ...
        public static void ConsoleCenterText(String text)
        {
